...
//        2
//       h                                              2
//T   =  -- ||( overrightarrow{k} +overrightarrow{G} )|| *delta_i,j
//k     2m
//

    func KineticTerm(k:[Double], g:[Double])-> Double{
        let v: [Double] = k + g
        //let constant = -( hbar  ↑ 2 )/(2*m_e)
    ...
    //this is supposed to return an nXn matrix
        ...
        //need to make form factors an object
        //var ff: [Double] = form_factors
        
        //let basis: (k_x:Double,k_y:Double,k_z:Double) = reciprocal_basis
...
//                    g[2] = Double(coefficients(m: i-n/2).l) * basis.k_z
                    ...
                    Hamiltonian_matrix[i][j] = KineticTerm(k:wave_vec , g:g)
